    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.updateSuccess ? "Votre profil a bien été mis à jour."
                : "";

            var userId = User.Identity.GetUserId();
            ApplicationUser currentUser = dbA.Users.FirstOrDefault(x => x.Id == userId);
        ...
        public ActionResult Edit(string id, string nom, string prenom, string email, string societe, string tel, string siret)
        {
            ManageMessageId? message;
            try
            {
                var fournisseur = dbA.Users.Find(User.Identity.GetUserId());
                if (ModelState.IsValid)
                {
                    ...
                    dbA.Entry(fournisseur).State = EntityState.Modified;
                    dbA.SaveChanges();
                }
            ...
            {
                System.Diagnostics.Debug.WriteLine("Exception: {0}", e.ToString());
