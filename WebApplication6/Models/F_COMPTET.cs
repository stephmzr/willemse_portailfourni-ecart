...
namespace PortailFournisseur.Models
{
    ...
    public partial class F_COMPTET
    {
        ...
        public Nullable<decimal> CAGNOTTE { get; set; }
        public Nullable<decimal> SOLDE_CAGNOTTE { get; set; }
        public string DATE_NAISSANCE { get; set; }
        public string COMMENTAIRE_1 { get; set; }
        public string COMMENTAIRE_2 { get; set; }
        public Nullable<decimal> TAUX_PR { get; set; }
    }
}
